...
import in.gov.cgg.vehiclereminderlatest.utils.DemoBase;
...
public class MultiLineChartActivity extends DemoBase implements OnSeekBarChangeListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        database = new Database(MultiLineChartActivity.this);
        setTitle("Chart");
...
//                double val = (Math.random() * seekBarY.getProgress()) + 3;
            if (z == 0) {
                values.add(new Entry(0, (float) 12));
                values.add(new Entry(1, (float) 20));
                values.add(new Entry(2, (float) 35));
                values.add(new Entry(3, (float) 65));
            } else {
                values.add(new Entry(0, (float) 14));
                values.add(new Entry(1, (float) 25));
                values.add(new Entry(2, (float) 39));
                values.add(new Entry(3, (float) 69));
            }
//            }
...
//        ((LineDataSet) dataSets.get(0)).enableDashedLine(10, 10, 0);
        ((LineDataSet) dataSets.get(0)).setColors(ColorTemplate.JOYFUL_COLORS);
