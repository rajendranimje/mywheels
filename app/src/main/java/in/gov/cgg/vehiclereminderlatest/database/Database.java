...
public class Database extends SQLiteOpenHelper {
    ...
    public Database(Context context) {
        super(context, GlobalDeclarations.DATABASE_NAME, null, 1);
        db = this.getWritableDatabase();
        this.context = context;
        calendar = Calendar.getInstance();
        GlobalDeclarations.DATABASE_PATH = context.getDatabasePath(GlobalDeclarations.DATABASE_NAME).getAbsolutePath();
        Log.i("databasePath", GlobalDeclarations.DATABASE_PATH);
...
//        db.execSQL("INSERT INTO " + servicing_tableName + "(ID,VehicleNo,Servicing_date,Next_Servicing_date ,Services ,Servicing_Km ,Next_Servicing_Km ,Date,Servicing_ID )VALUES('" + id + "','" + GlobalDeclarations.VEHICLENO + "','" + servicingDetails.getCurrentDate() + "','" + servicingDetails.getNext_date() + "','" + servicingDetails.getServices() + "','" + servicingDetails.getKm() + "','" + servicingDetails.getNext_km() + "','" + servicingDetails.getCurrentDate() + "','" + servicingDetails.getId() + "')");
    ...
    public ArrayList<InsuranceDetails> getInsuranceDetailsList(String vehicleNo) {
        ...
        if (c.moveToFirst()) {
            do {
                ...
                insuranceDetails.setVehicleNo(c.getString(c.getColumnIndex(vehicle_no)));
    ...
    public ArrayList<PollutionDetails> getPollutionDetailsList(String vehicleNo) {
        ...
        if (c.moveToFirst()) {
            do {
                ...
                pollutionDetails.setVehicleNo(c.getString(c.getColumnIndex(vehicle_no)));
    ...
    public ArrayList<ServicingDetails> getServicingDetailsList(String vehicleNo) {
        ...
        if (c.moveToFirst()) {
            do {
                ...
                servicingDetails.setVehicleNo(c.getString(c.getColumnIndex(vehicle_no)));
    ...
    public void deleteInsuranceData(InsuranceDetails details) {

        this.insuranceDetails = details;
        db.execSQL("DELETE FROM " + insurance_tableName + " WHERE " + vehicle_no + "= '" + GlobalDeclarations.VEHICLENO + "' AND Insurance_photo= '" + insuranceDetails.getImage() + "' AND Insurance_validFrom= '" + insuranceDetails.getValidFrom() + "' AND Insurance_validUpto= '" + insuranceDetails.getValidUpto() + "' AND Insurance_agency= '" + insuranceDetails.getAgency() + "'");
